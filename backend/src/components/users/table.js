...
function Table({columns, data, handleEditClick, confirmDelete, editContentId, handleCancelClick,handleEditFormChange, editFormData}) {
...
function App(props) {
  ...
  return (
    <Styles>
      <Table data={data} columns={columns} handleEditClick={handleEditClick} confirmDelete={confirmDelete} editContentId={editContentId} handleCancelClick={handleCancelClick} handleEditFormChange={handleEditFormChange} editFormData={editFormData} />
    </Styles>
  )
