...
import Editable from "../indicators/Editable";
...
// function Homestats_table({columns, data, handleEditClick, confirmDelete, editContentId, handleCancelClick,handleEditFormChange, editFormData, EditImageHandler}) {
//   const [filterInput, setFilterInput] = useState("");
function Homestats_table({columns, data}) {
  const [filterInput, setFilterInput] = useState("");
       ...
       <table {...getTableProps()}>
        ...
        <tbody {...getTableBodyProps()}>
              ...
              { data.map((cell, index) => (
                ...
                //   <td>{cell.statName}</td>
                //   <td>{cell.statDesc}</td>
                //   <td>{cell.statValue}</td>
                //   <td>{cell.statPrefix}</td>
                //   <td>{cell.statSource}</td>
                //   <td>{cell.created_at
                //                   ? format(
...
function App(props) {
  ...
  return (
    <Styles>
      {/* <Homestats_table data={data} columns={columns} handleEditClick={handleEditClick} confirmDelete={confirmDelete} editContentId={editContentId} handleCancelClick={handleCancelClick} handleEditFormChange={handleEditFormChange} editFormData={editFormData} EditImageHandler={EditImageHandler} /> */}
      <Homestats_table data={data} columns={columns}  />
