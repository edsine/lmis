...
import Table from "../indicators/table";
...
const Homepage = () => {
    ...
    const saveData = async (data) => {
        setLoading(true);
        await Indicators.saveNewIndicator(data).then(
            (response) => {
                //let value = await response.json();
                // alert(JSON.stringify(response.data));
                //setContents(response.data)
    ...
    const veryIndicator = async (data) => {
        setLoading(true);
        await Indicators.verifyIndicator(data).then(
            (response) => {
                //let value = await response.json();
                        ...
                        <div className="">
                            <form enctype="multipart/form-data">
                                <div className="modal-header">
                                    <h4 className="modal-title fs-20">Add New Services</h4>
                                    <button
                                        type="button"
                                        className="btn-close"
