...
import HomestatService from "../../services/homestats.service";
import EventBus from "../../common/EventBus";
import Datatable from "./homestat_table";
import Loader from "../include/loader";
import IndicatorService from "../../services/indicator.service";
import { format, compareAsc } from "date-fns";
import { useSelector } from "react-redux";
import authHeader from "../../services/auth-header";
import homestatsService from "../../services/homestats.service";
...
const HomepageStats = () => {
    ...
    const fetchData = async () => {
      setLoading(true);
      const res = await HomestatService.getHomestats().then(
        (response) => {
    ...
    const saveData = async (data) => {
      setLoading(true);
      await HomestatService.saveNewHomestat(data).then(
        (response) => {
          //let value = await response.json();
          // alert(JSON.stringify(response.data));
          //setContents(response.data)
    ...
    const updateData = async (data) => {
      setLoading(true);
      await homestatsService.updateNewHomestat(data).then(
        (response) => {
          //let value = await response.json();
          // alert(JSON.stringify(response.data));
          //setContents(response.data)
    ...
    const handleDeleteClick = async (contentId) => {
      ...
      const config = {
        method: "delete",
        url: homestatsService.API_URL + "homestat/" + contentId,
        headers: {
    ...
    return (
      ...
      <>
      { loading ? <Loader /> : ''}
        <PageTitle activeMenu="Home Stats" motherMenu="Home" />
        <div className="col-12">
              ...
              <div className="">
                <form enctype="multipart/form-data">
                  <div className="modal-header">
                    <h4 className="modal-title fs-20">Add New Data Value</h4>
                    <button
                      type="button"
                      className="btn-close"
          ...
          <div className="card">
            <div className="card-header">
              <h4 className="card-title">List of Home Statistical Information</h4>
            ...
            <div className="card-body">
              <div className="w-100 table-responsive">
                <div id="example_wrapper" className="dataTables_wrapper">
                  ...
                  {/* {showTable && <Datatable tabledata={tabledata} confirmDelete={confirmDelete} handleEditClick={handleEditClick} editContentId={editContentId} handleCancelClick={handleCancelClick} handleEditFormChange={handleEditFormChange} editFormData={editFormData} EditImageHandler={EditImageHandler} />} */}

                  {showTable && <Datatable tabledata={tabledata} 
